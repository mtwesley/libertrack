...
class Model_ACL_User extends Model_Auth_User {
	...
	public function add_role($role)
	{
		...
		if (Kohana::$config->load('acl.support_capabilities') == TRUE)
		{
	...
	public function add_capability($capability)
	{
		...
		if (Kohana::$config->load('acl.capabilties_limited_by_role'))
		{
	...
	public function roles_list()
	{
		...
		{
			$roles[] = Kohana::$config->load('acl.public_role');
			return $roles;
		}
	...
	public function capabilities_list()
	{
		...
		if (Auth::instance()->logged_in() AND Kohana::$config->load('acl.support_capabilities'))
		{
