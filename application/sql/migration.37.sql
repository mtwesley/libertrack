...
alter table ldf_data add column original_species_id d_id;
alter table ldf_data add column original_diameter d_diameter;
alter table ldf_data add column original_length d_length;
...
alter table ldf_data alter column original_species_id set not null;
alter table ldf_data alter column original_diameter set not null;
alter table ldf_data alter column original_length set not null;
