...
//    'D' => 'Deleted',
  ...
  {
    return (string) number_format(ceil($float * pow(10, $precision)) / pow(10, $precision), $precision);
  }

  public static function quantitify($quantity, $precision = 3)
  {
    return (string) number_format(ceil($quantity * pow(10, $precision)) / pow(10, $precision), $precision);
  }

  public static function amountify($amount, $precision = 2)
  {
    return (string) number_format(ceil($amount * pow(10, $precision)) / pow(10, $precision), $precision);
  }
