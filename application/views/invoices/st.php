...
<div class="st-invoice invoice <?php if ($options['break']) echo 'invoice-page-break'; ?>">
  ...
  <div class="invoice-header">
    ...
    <div class="invoice-title"><?php if ($invoice->is_draft) echo 'Draft '; ?>Proforma Stumpage Invoice</div>
  ...
  <div class="invoice-summary">
    <table class="invoice-summary-table">
      ...
      */ ?>
      ...
      <tr class="total">
        <td class="volume"><?php echo SGS::quantitify($total['summary']['volume']); ?></td>
        <td class="items" colspan="2"><?php echo $total['summary']['count']; ?></td>
        <td class="fee_desc">
          Stumpage Fee (GoL)<br />
          <em>FDA Regulation 107-7, Section 22(b)</em>
        </td>
